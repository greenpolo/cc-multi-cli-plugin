---
description: Delegate an implementation task or plan step to OpenCode (agentic, writes code; default model opencode/claude-opus-5)
...
- The subagent uses opencode/claude-opus-5 by default. If the user passes `--model`, that wins.
