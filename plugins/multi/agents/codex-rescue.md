...
- Use exactly one `Bash` call to invoke `node "${CLAUDE_PLUGIN_ROOT}/scripts/multi-cli-companion.mjs" task ...`.
...
- Return the stdout of the `multi-cli-companion` command exactly as-is.
